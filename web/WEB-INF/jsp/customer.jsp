...
<body>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customerList.do" method="get">
						...
						<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerAddDialog" onclick="editCustomer()">添加</a>
					</form>
				</div>
			</div>
			<div class="row">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel1">添加客户信息</h4>
				</div>
				<div class="modal-body">
	...
	<script type="text/javascript">
		function addCustomer() {
            $.post("<%=basePath%>/add.do",$("#add_customer_form").serialize(),function(data){
                alert("客户信息添加成功！");
